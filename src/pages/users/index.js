            ...
            <ScrollView
                ...
                <View style={_styleSheet["users"]}>
                    ...
                    <View style={_styleSheet["users-link"]}>
                        <TouchableWithoutFeedback onPress={() => this.props.navigation.navigate('MessageList')} style={_styleSheet["index__Navigator"]}>
                            <View style={_styleSheet["users-link__item"]}>
                                ...
                                <View style={_styleSheet["users-link__title"]}>
                                    <Text style={_styleSheet["users-link__title-text"]}>消息中心</Text>
                                </View>
                                <View style={_styleSheet["users-link__subtitle"]}>
                                    <Text style={_styleSheet["users-link__subtitle-text"]}></Text>
                                </View>
                        ...
                        <TouchableWithoutFeedback onPress={() => this.props.navigation.navigate('NoticeList')} style={_styleSheet["index__Navigator"]}>
                            <View style={_styleSheet["users-link__item"]}>
                                <View style={_styleSheet["users-link__icon"]}>
                                    <Image
                                        style={_styleSheet["users-link__icon-help"]}
                                ...
                                <View style={_styleSheet["users-link__title"]}>
                                    <Text style={_styleSheet["users-link__title-text"]}>公告中心</Text>
                                </View>
                                <View style={_styleSheet["users-link__subtitle"]}>
                                    <Text style={_styleSheet["users-link__subtitle-text"]}></Text>
                                </View>
                        ...
                        <TouchableWithoutFeedback onPress={() => this.props.navigation.navigate('HelpList')} style={_styleSheet["index__Navigator"]}>
                            <View style={_styleSheet["users-link__item"]}>
                                <View style={_styleSheet["users-link__icon"]}>
                                    <Image
                                        style={_styleSheet["users-link__icon-help"]}
                                ...
                                <View style={_styleSheet["users-link__title"]}>
                                    <Text style={_styleSheet["users-link__title-text"]}>帮助中心</Text>
                                </View>
                                <View style={_styleSheet["users-link__arrow"]}>
                                    <Image
                                        style={_styleSheet["users-link__arrow--active"]}
                        ...
                        <TouchableWithoutFeedback onPress={() => this.props.navigation.navigate('Setting')} style={_styleSheet["index__Navigator"]}>
                            <View style={_styleSheet["users-link__item"]}>
                                <View style={_styleSheet["users-link__icon"]}>
                                    <Image
                                        style={_styleSheet["users-link__icon-help"]}
                                ...
                                <View style={_styleSheet["users-link__title"]}>
                                    <Text style={_styleSheet["users-link__title-text"]}>设置</Text>
                                </View>
                                <View style={_styleSheet["users-link__arrow"]}>
                                    <Image
                                        style={_styleSheet["users-link__arrow--active"]}
